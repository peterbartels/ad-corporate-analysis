...
| `url` | link | yes | Target, e.g. localized version of the story. |
| `icon` | string | no | Icon identifier (translate, arrow, ...). |
| `iconPosition` | string | no | Enum: left | right (observed: left). |
