...
**Component:** `back-link`  
**DEPT mapping:** NEW - Back Link  
**Used on:** 173 page(s)

Simple styled text link at the top of article pages leading back to the parent listing (e.g. 'Life at AD'). Present on nearly every article template.
...
![Back Link example — /en/home/careers/employee-stories/andrea-gissi](examples/back-link.png)

*Captured live from [/en/home/careers/employee-stories/andrea-gissi](https://www.averydennison.com/en/home/careers/employee-stories/andrea-gissi.html) — see the [page composition](../pages/en_home_careers_employee-stories_andrea-gissi/composition.md).*

## CMS data model

| Field | Type | Required | Description |
|---|---|---|---|
| `label` | string | yes | Link text, e.g. 'Life at AD'. |
| `url` | link | yes | Target listing page. |
