...
**Page:** [/en/home/news/press-releases/avery-dennison-invests-in-series-b-funding-of-3d-current-collectors-manufacturer-addionics](https://www.averydennison.com/en/home/news/press-releases/avery-dennison-invests-in-series-b-funding-of-3d-current-collectors-manufacturer-addionics.html)  
...
3. `media-contacts` — right-rail 'Media contacts' with per-organization groups (Avery Dennison and the partner company)
   Margin below: n/a (sidebar)
4. `image` — product/partner photograph with a small caption line below (e.g. 'Image courtesy of ...')
   Margin below: 50px (section-buffer)
5. `social-share` — 'Share' with Facebook, X, LinkedIn, email icons between hairline rules
   Margin below: ~48px (visual)
6. `richtext` — body: italic subheadline, dateline lead, announcement copy, executive quotes
   Margin below: 50px (section-buffer)
