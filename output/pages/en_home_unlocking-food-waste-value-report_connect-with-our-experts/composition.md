...
**Page:** `/en/home/unlocking-food-waste-value-report/connect-with-our-experts`  
...
1. `campaign-stat-hero` — same full-width photo hero as the campaign home (eyebrow, h1, subheading, rule-separated stat lines) but without a CTA button. Margin below: 100px (content-buffer, 10rem).
2. `richtext` — h2 section heading "Connect with our experts". Margin below: 50px (section-buffer, 5rem).
