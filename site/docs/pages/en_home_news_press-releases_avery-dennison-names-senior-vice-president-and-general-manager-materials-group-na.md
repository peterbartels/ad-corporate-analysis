---
title: "avery-dennison-names-senior-vice-president-and-general-manager-materials-group-na"
---

<!-- generated: component composition analysis -->
**Page:** [`/en/home/news/press-releases/avery-dennison-names-senior-vice-president-and-general-manager-materials-group-na`](/pages/en_home_news_press-releases_avery-dennison-names-senior-vice-president-and-general-manager-materials-group-na)  
...
3. [`media-contacts`](/components/media-contacts) — right-rail 'Media contact' block, optionally labeled per organization, with investor- and media-relations groups
   Margin below: n/a (sidebar)
4. [`image`](/components/image) — lead visual: solid brand-color card with the Avery Dennison logo (or similar branded graphic)
   Margin below: 50px (section-buffer)
...
6. [`richtext`](/components/richtext) — short body: bold dateline lead and one or two paragraphs of announcement copy
   Margin below: 50px (section-buffer)
...
<img src="/screens/en_home_news_press-releases_avery-dennison-names-senior-vice-president-and-general-manager-materials-group-na.webp" alt="Full-page screenshot of /en/home/news/press-releases/avery-dennison-names-senior-vice-president-and-general-manager-materials-group-na" loading="lazy" style="max-width:100%;border:1px solid var(--vp-c-divider);border-radius:6px;" />
