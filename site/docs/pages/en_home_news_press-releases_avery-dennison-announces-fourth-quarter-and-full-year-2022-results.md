---
title: "avery-dennison-announces-fourth-quarter-and-full-year-2022-results"
---

<!-- generated: component composition analysis -->
**Page:** [/en/home/news/press-releases/avery-dennison-announces-fourth-quarter-and-full-year-2022-results](https://www.averydennison.com/en/home/news/press-releases/avery-dennison-announces-fourth-quarter-and-full-year-2022-results.html)  
...
1. [`back-link`](/components/back-link) — underlined '<- Back to all press releases' link at the top of the content area
   Margin below: ~48px (visual)
2. [`article-header`](/components/article-header) — H1 headline plus a 'Download story as PDF' link
   Margin below: ~40px (visual)
3. [`media-contacts`](/components/media-contacts) — right-rail 'Media Contacts' block: MEDIA RELATIONS and INVESTOR RELATIONS groups with name, role and mailto link
   Margin below: n/a (sidebar)
4. [`button`](/components/button) — 'Related' heading with a black pill button linking to the Financial Review and Analysis document, below the contacts in the sidebar
   Margin below: n/a (sidebar)
5. [`image`](/components/image) — full-column-width quarter graphic (e.g. large 'Q4 2022' artwork) acting as the lead visual
   Margin below: ~40px (visual)
6. [`social-share`](/components/social-share) — 'Share' label with Facebook, X, LinkedIn and email icons, framed by hairline rules
   Margin below: ~48px (visual)
7. [`richtext`](/components/richtext) — the complete earnings release: highlights bullet list, dateline lead paragraph, CEO quotes, results by segment with nested lists, balance sheet / taxes / guidance sections, '###' sign-off
   Margin below: ~64px (visual)
8. [`richtext`](/components/richtext) — boilerplate: About Avery Dennison, Safe Harbor statement and forward-looking risk factors
   Margin below: ~56px (visual)
9. [`back-link`](/components/back-link) — repeated '<- Back to all press releases' link at the bottom
...
<img src="/screens/en_home_news_press-releases_avery-dennison-announces-fourth-quarter-and-full-year-2022-results.webp" alt="Full-page screenshot of /en/home/news/press-releases/avery-dennison-announces-fourth-quarter-and-full-year-2022-results" loading="lazy" style="max-width:100%;border:1px solid var(--vp-c-divider);border-radius:6px;" />
