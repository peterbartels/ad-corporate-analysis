---
title: "avery-dennison-materials-group-names-matthias-matt-liebert-as-general-manager-for-taylor-adhesives"
---
...
3. [`media-contacts`](/components/media-contacts) — right-rail 'Media contact' block: media-relations and investor-relations contacts (name, role, mailto)
   Margin below: n/a (sidebar)
4. [`image`](/components/image) — lead visual, e.g. split-panel dual-logo lock-up of the two companies
   Margin below: 50px (section-buffer)
...
6. [`richtext`](/components/richtext) — body: italic subheadline, dateline lead, announcement copy and executive quotes, '###'
   Margin below: 50px (section-buffer)
...
<img src="/screens/en_home_news_press-releases_avery-dennison-materials-group-names-matthias-matt-liebert-as-general-manager-for-taylor-adhesives.webp" alt="Full-page screenshot of /en/home/news/press-releases/avery-dennison-materials-group-names-matthias-matt-liebert-as-general-manager-for-taylor-adhesives" loading="lazy" style="max-width:100%;border:1px solid var(--vp-c-divider);border-radius:6px;" />
