...
**Page:** [/en/home/industries/logistics](https://www.averydennison.com/en/home/industries/logistics.html)  
**Template cluster:** `66ee72a4fb` (industry landing page)  
*Rem base: the site sets `html { font-size: 62.5% }` at desktop widths (>=1180px), so 1rem = 10px in all margin values below.*

# Industry landing page — Logistics
...
<img src="/screens/en_home_industries_logistics.webp" alt="Full-page screenshot of /en/home/industries/logistics" loading="lazy" style="max-width:100%;border:1px solid var(--vp-c-divider);border-radius:6px;" />
