...
**Page:** [`/en/home/careers/early-career-opportunities/europe/research-and-development`](/pages/en_home_careers_early-career-opportunities_europe_research-and-development)  
...
1. [`richtext`](/components/richtext) - back link to the parent graduate-program page. Margin below: ~55px (visual estimate).
2. [`richtext`](/components/richtext) - main column: h1 stream title, intro paragraphs, "Your tasks may include" bullet list and a "Qualifications" section with an expectations list. Margin below: ~90px (mg-tp-l, 5.6rem, before the contact band).
3. [`cta-block`](/components/cta-block) - right sidebar with a single group: "Don't see the role you're looking for?" text and "Join talent community" button. Margin below: ~90px.
4. [`richtext`](/components/richtext) - full-width light-gray contact band: centered "Contact Us" heading, FAQ link and recruiter mailto link. Margin below: ~30px.
5. [`form-block`](/components/form-block) - AEM avd-form contact form inside the band (fields configured per page; shown as the email prompt on these stream pages). Margin below: ~80px to page end.
...
<img src="/screens/en_home_careers_early-career-opportunities_europe_research-and-development.webp" alt="Full-page screenshot of /en/home/careers/early-career-opportunities/europe/research-and-development" loading="lazy" style="max-width:100%;border:1px solid var(--vp-c-divider);border-radius:6px;" />
